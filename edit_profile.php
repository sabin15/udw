    ...
    <div class="container" id="student-form">
      ...
      <?php
        if($type=='student'){
          ...
          $query = "select * from staff WHERE id='12'";
          $result=mysqli_query($conn,$query);
          while ($row = mysqli_fetch_array($result)){
        ...
        <form class="form-horizontal" method='post' action="" enctype="multipart/form-data" id="student_form">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" class="form-control" id="student-id" name="user_id" required value="<?php echo $row['id'];?>">
            </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" class="form-control" id="student-name" name="name" placeholder="Please enter Name" value="<?php echo $row['email'];?>" required>
             </div>
            </div>
          </div>
          <div class="form-group">
